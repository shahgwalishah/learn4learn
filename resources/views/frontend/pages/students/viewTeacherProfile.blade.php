            ...
            <div class="col-12" id="std-dashboard-left">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-12 justify-content-center text-center">
                        <img src="/storage/images/{{$db[0]->thumbnail}}" onerror="this.src='{{asset('asset/images/teachers/t-1.jpg')}}'" alt="" id="stud-profile-pic">
                    </div>
                    <div class="col-md-8 col-sm-8 col-xs-12 justify-content-center text-center">
                        ...
                        <p class="stud-date"><b>Description: </b> {{$db[0]->description}} </p><br>
