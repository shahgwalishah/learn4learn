                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-12 media">
                            <iframe width="420" height="345" src="https://www.youtube.com/embed/{{$lesssonDetail->lessons[0]['link']}}" allowfullscreen>
                            </iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="row">
                        <div class="col-md-9 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <img style="border-radius: 100px;" src="{{url('/storage/images/'.$lesssonDetail->thumbnail)}}">
                                </div>
                                <div class="col-md-5">
                                    <p style="margin: 8px;">{{$lesssonDetail->fname}}-{{$lesssonDetail->lname}}</p>
                                </div>
                                <div class="col-md-5">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p data-animation="fadeInUp" data-delay="1.5s">{{$lesssonDetail->lessons[0]['description']}}</p>
