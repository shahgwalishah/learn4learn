                    ...
                    <div class="header-right d-flex justify-content-end">
                        ...
                        @if(Auth::check())
                            ...
                            <div class="login-register" style="margin-right: 30px">
                                ...
                                <a href='/teacher-home' style='color:#000;'>{{\Auth::user()->fname}} {{\Auth::user()->lname}}</a>
                                <div class="dropdown">
                                ...
                                <a href='/students/Home' style='color:#000;'>{{\Auth::user()->fname}} {{\Auth::user()->lname}}</a>
                                <div class="dropdown">
                                    <button data-toggle="dropdown" class="customClass">
                                        <i class="fa fa-cog" aria-hidden="true"></i></button>
                                    <ul class="dropdown-menu showablemenu">
                                        ...
                                        <p class="customClassBox"><a style="color: black"
                                                                     href="{{route('student_edit_profile')}}">
                                                                     <i class="fas fa-edit customFaClas"></i>
                                                                     @lang('home.Edit_Profile')
                                                                    </a>
                                        </p>
                                        <form method="post" action="{{route('logout')}}" class="customClassBox">
                                            @csrf
