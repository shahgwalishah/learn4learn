...
<section id="slider-part" class="slider-active">
    <div class="single-slider slider-4 bg_cover pt-150"
        ...
        <div class="container">
            <div class="row justify-content-center customStudentSearching">
...
<section class="admission-row pb-120 customSetting">
    <div class="container p-5 bg_cover gray-bg customStyling">
        <div class="row">
...
<section class="admission-row pb-120" id="filter-search-form">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h5 style="color: #006796;font-size: 28px;letter-spacing: 3px;" class="customWord">Filter By</h5>
