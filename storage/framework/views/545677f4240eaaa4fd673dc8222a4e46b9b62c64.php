                                ...
                                <div id="myModal-<?php echo e($message->id); ?>" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form>
                                                <input type="hidden" id="student_id" value="<?php echo e($message->from_user_id); ?>" />
    ...
    <script>
        ...
        new Vue({
            ...
            data: {
                message:'',
                teacher_id:'',
                teacher_id:'<?php echo e(\Auth::user()->id); ?>',
                loader:false
            },
            methods:{
                sendMessage() {
                    if (this.message == '') {
                        ...
                        console.log('data');
                        console.log(data);
                        let url = '<?php echo e(route('OurStudentMessages')); ?>';
                        this.loader = true;
...
<?php echo $__env->make('layouts.teachersmaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mustafa/Desktop/rikxtech/learnforlearning/resources/views/frontend/pages/teachers/myMessages.blade.php ENDPATH**/ ?>