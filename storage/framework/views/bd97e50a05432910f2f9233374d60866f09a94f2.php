        ...
        <ul class="nav">
            <li <?php if(isset($pageSlug) && $pageSlug=='dashboard' ): ?> class="active " <?php endif; ?>>
                <a href="<?php echo e(route('home')); ?>">
                    ...
                    <p id="repl"><?php echo e(__('Dashboard')); ?></p>
                </a>
            </li>
            <li>
                    ...
                    <ul class="nav pl-4">
                        ...
                        <li <?php if(isset($pageSlug) && $pageSlug=='users' ): ?> class="active " <?php endif; ?>>
                            <a href="<?php echo e(route('userManagement')); ?>">
                                ...
                                <p id="repl"><?php echo e(__('User')); ?></p>
                            </a>
                        </li>
                    </ul>
                </div>
            ...
            <li>
                <a data-toggle="collapse" href="#poster_colap" aria-expanded="true">
                    ...
                    <span class="nav-link-text" id="repl"><?php echo e(__('Posters')); ?></span>
                    <b class="caret mt-1" id="repl3"></b>
                </a>
                    ...
                    <ul class="nav pl-4">
                        ...
                        <li <?php if(isset($pageSlug) && $pageSlug=='forteacher' ): ?> class="active " <?php endif; ?>>
                            <a href="<?php echo e(route('forTeacher')); ?>">
                                <i class="tim-icons icon-pencil" id="repl3"></i>
                                <p id="repl"><?php echo e(__('forteacher')); ?></p>
                            </a>
                        </li>
                        ...
                        <li <?php if(isset($pageSlug) && $pageSlug=='forstudent' ): ?> class="active " <?php endif; ?>>
                            <a href="<?php echo e(route('forStudent')); ?>">
                                <i class="tim-icons icon-pencil" id="repl3"></i>
                                <p id="repl"><?php echo e(__('forstudent')); ?></p>
                            </a>
                        </li>
                        ...
                        <li <?php if(isset($pageSlug) && $pageSlug=='forparents' ): ?> class="active " <?php endif; ?>>
                            <a href="<?php echo e(route('forParents')); ?>">
                                <i class="tim-icons icon-pencil" id="repl3"></i>
                                <p id="repl"><?php echo e(__('ForParents')); ?></p>
                            </a>
                        </li>
            ...
            <li>
                <a href="<?php echo e(route('email-config')); ?>">
                    ...
                    <p id="repl"><?php echo e(__('Mail Configuration')); ?></p>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('pages.index')); ?>">
                    <i class="tim-icons icon-settings" id="repl3"></i>
                    <p id="repl"><?php echo e(__('Pages')); ?></p>
                </a>
            </li>
            <li>
            <a href="<?php echo e(route('subjects.index')); ?>">
                    <i class="tim-icons icon-settings" id="repl3"></i>
                    <p id="repl"><?php echo e(__('Subjects')); ?></p>
                </a>
            </li>
...
<?php /**PATH /home/mahad/Desktop/rixtexh/learn4learn/resources/views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>